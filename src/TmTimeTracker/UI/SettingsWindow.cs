...
public sealed class SettingsWindow : Form
{
    ...
    private readonly FlatButton _tabTokens;
    ...
    private readonly Lazy<Control> _tokensPage;
    ...
    public SettingsWindow(IServiceProvider sp, ILogger<SettingsWindow> log)
    {
        ...
        _tokensPage       = new Lazy<Control>(() => new ApiTokensPage(_sp, _log));
        ...
        _tabTokens       = MakeTabButton("API tokens");
        ...
        _tabTokens.Click       += (_, _) => Activate(_tabTokens,       _tokensPage.Value);
        ...
        foreach (var t in new[] { _tabConnection, _tabRepositories, _tabSlack, _tabTokens, _tabOAuthApp })
        {
